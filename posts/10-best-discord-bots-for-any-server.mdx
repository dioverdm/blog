...
Invite [Would You](https://wouldyoubot.gg/invite) to your server.
...
HallowsTreat is a fun and interactive bot that allows you to collect candy, give and steal candy from your server mates, and claim glory by getting the most candy! It's a great way to bring your server members together and have fun while doing it.
